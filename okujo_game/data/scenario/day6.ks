...
[tb_show_message_window  ]
[jump  storage="day6.ks"  target="*様子を見る_好感度高"  cond="f.likability>8"  ]
[tb_start_text mode=1 ]
瑞希くんは欠伸をした。[p]
...
[jump  storage="day6.ks"  target="*雑談_好感度高"  cond="f.likability>8"  ]
[tb_start_text mode=1 ]
...
[jump  storage="day6.ks"  target="*サプライズ_好感度高"  cond="f.likability>8"  ]
[tb_start_text mode=1 ]
#瑞希
「うん、ありがとう」[p]
#
...
[jump  storage="day6.ks"  target="*作業をする_好感度高"  cond="f.likability>8"  ]
[tb_start_text mode=1 ]
