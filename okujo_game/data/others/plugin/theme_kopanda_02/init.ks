...
; メッセージウィンドウの設定
[position layer=message0 width=960 height=200 top=460 left=0]
[position layer=message0 page=fore frame="../others/plugin/theme_kopanda_02/image/frame_message.png" margint="40" marginl="20" marginr="25" marginb="60" opacity=&mp.frame_opacity ]

; 名前枠の設定
[ptext name="chara_name_area" layer="message0" color="&mp.name_color" size=24 x=40 y=465]
